...
export default function TeacherHeader({ setSidebarOpen }: TeacherHeaderProps) {
    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className="lg:hidden text-gray-500 hover:text-[#F97316] focus:outline-none p-1"
        >
      ...
      <div className="flex items-center gap-6">
        <div className="hidden md:flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-gray-600">Halo, Pak/Bu {userName.split(' ')[0]}</span>
        </div>
